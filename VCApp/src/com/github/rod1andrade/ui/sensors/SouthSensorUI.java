...
public final class SouthSensorUI extends SensorUI {
    ...
    public SouthSensorUI(int posX, int posY, int width, int height, String label, VacuumCleanerModel vacuumCleanerModel, boolean isDebugMode) {
    ...
    public synchronized boolean doAnimation() {
        return vacuumCleanerModel.hasCollision() && vacuumCleanerModel.collidedDirection() == VacuumCleanerRenderEntity.DIRECTION_DOWN;
    }
}
